...
<?php render_open_graph(); ?>
    ...
    <link rel="stylesheet" href="<?= asset_url('../styles/conekta.css') ?>" />
    <!-- Fuente de texto -->
...
<body>
    ...
    <section class="hero-conekta">
        <div class="hero-content">
            <div class="hero-text">
                <h1 style="margin-bottom: 10px;">Conekta</h1>
                <p class="text-p3" style="margin-bottom: 0px;">Nuestra plataforma EdTech</p>
            </div>

            <div class="hero-logo">
                <img src="../recursos-multimedia/logos/logo-conekta.webp" alt="Logo de Conekta plataforma EdTech de aprendizaje corporativo">
            </div>
        </div>
    </section>
    ...
    <section class="success-section">
        <div class="success-container">
            <div class="success-text">
                <h3>El motor que hace posible todas las rutas:</h3>
                <ul>
                    <li class="text-p2">Gestión centralizada de los procesos de aprendizaje.</li>
                    <li class="text-p2">Tecnología educativa avanzada, con IA y altamente interactiva.</li>
                    <li class="text-p2">Aprendizaje personalizado, adaptado a las prioridades de cada colaborador.</li>
                </ul>
            </div>

            <div class="success-image">
                <img src="../recursos-multimedia/conekta/mujer-trabajando.webp" alt="Profesional utilizando plataforma digital de aprendizaje corporativo">
            </div>
        </div>
    </section>
    ...
    <section class="cards-section-desarrollo">
        <div class="cards-container-desarrollo">
            <div class="card-desarrollo">
                <img src="../recursos-multimedia/conekta/card-a-1.webp" alt="Profesional haciendo uso de la plataforma Conekta con programas y cursos organizados">
                <div class="card-desarrollo-body">
                    <h4>Conekta integra en un solo entorno los programas, cursos, módulos y actividades, permitiendo al usuario acceder de forma clara y organizada a toda su información.</h4>
                </div>
            </div>

            <div class="card-desarrollo">
                <img src="../recursos-multimedia/conekta/card-a-2.webp" alt="Progreso de aprendizaje en plataforma Conekta">
                <div class="card-desarrollo-body">
                    <h4>Desde la plataforma es posible visualizar el progreso, revisar contenidos, conocer la estructura del programa, gestionar sesiones incluidas y consultar la información del consultor asignado.</h4>
                </div>
            </div>

            <div class="card-desarrollo">
                <img src="../recursos-multimedia/conekta/card-a-3.webp" alt="Ruta de aprendizaje optimizada dentro de la plataforma Conekta">
                <div class="card-desarrollo-body">
                    <h4>Su diseño facilita una navegación intuitiva, donde cada persona puede entender en qué punto se encuentra dentro de su ruta y cuáles son los siguientes pasos.</h4>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="video-section">
        <div class="video-container">
            <div class="video-wrapper">
                <iframe 
                    src="https://www.youtube.com/embed/66y8sBR_La8"
                    title="Video Conekta"
                    frameborder="0"
