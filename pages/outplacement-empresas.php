    ...
    <section class="ecosistema">
        <div class="container ecosistema-grid">
            <div class="ecosistema-content">
                ...
                <div class="eco-item">
                    ...
                    <div class="eco-text">
                        ...
                        <ul>
                            <li class="text-p3">Conekta, plataforma tecnológica de aprendizaje</li>
            ...
            <div class="ecosistema-img">
                <img src="../recursos-multimedia/outplacement-empresas/ecosistema-img.webp" alt="Ecosistema de apoyo profesional con formación, networking y acompañamiento">
            </div>
        </div>
    </section>
